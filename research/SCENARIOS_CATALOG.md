...
Sources : Exemples Anne-Francoise, TopSolidKernelAutomationExamples, exemples unitaires VB/C#
...
| S-008 | Chercher objets par proprietes | R | Pdm.SearchObjectsWithProperties | Medium | ❌ | 🟡 | Anne-Francoise |
| S-009 | Lister tous les projets (working + libraries) | R | Pdm.GetProjects(bool, bool) | Simple | ❌ | 🟢 | Anne-Francoise |
| S-010 | Lister dossiers de projets (racine) | R | Pdm.WorkingProjectsRootFolder, Pdm.GetProjectFolderConstituents | Simple | ❌ | 🟡 | Anne-Francoise |
| S-011 | Date sauvegarde et commentaire PDM | R | Pdm.GetSavingDate, Pdm.GetComment | Simple | ❌ | 🟡 | Anne-Francoise |
| S-012 | Afficher dans arbre projets | R | Pdm.ShowInProjectTree | Simple | ❌ | 🟡 | Anne-Francoise |
| S-013 | Lister connexions PDM disponibles | R | Pdm.GetAvailablePdmConnections | Simple | ❌ | 🟡 | Anne-Francoise |
...
| S-056 | Creer parametre couleur | W | Parameters.CreateColorParameter | Simple | ❌ | 🟢 | Anne-Francoise |
| S-057 | Creer parametres relayes (Real/Bool/Int/Text/Color) | W | Parameters.Create*RelayedParameter | Medium | ❌ | 🟢 | Anne-Francoise |
| S-058 | Gerer valeurs possibles couleur | RW | Parameters.Get/SetColorParameterPossibleValues | Medium | ❌ | 🟢 | Anne-Francoise |
| S-059 | Creer parametres table (Real/Color) | W | Parameters.CreateRealTableParameter, CreateColorTableParameter | Complex | ❌ | 🟢 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-070 | Lister les shapes du document | R | Shapes.GetShapes, Elements.GetFriendlyName | Simple | ❌ | 🟢 | Anne-Francoise |
| S-071 | Lire les faces d'un shape | R | Shapes.GetFaces, Shapes.GetFaceEnclosingCoordinatesWithGivenFrame | Medium | ❌ | 🟢 | Anne-Francoise |
| S-072 | Creer un point 3D | W | Geometries3D.CreatePoint + Pattern D | Simple | ❌ | 🟢 | Anne-Francoise |
| S-073 | Creer un repere (frame) | W | Geometries3D.CreateFrame + Pattern D | Simple | ❌ | 🟢 | Anne-Francoise |
| S-074 | Creer repere point + 2 directions | W | Geometries3D.CreateFrameByPointAndTwoDirections + Pattern D | Medium | ❌ | 🟢 | Anne-Francoise |
| S-075 | Creer repere avec offset | W | Geometries3D.CreateFrameWithOffset + Pattern D | Medium | ❌ | 🟢 | Anne-Francoise |
| S-076 | Lire plans absolus (XY, XZ, YZ) | R | Geometries3D.GetAbsoluteXYPlane, GetAbsoluteOriginPoint | Simple | ❌ | 🟢 | InclusionManager |
| S-077 | Transformer un element (translation/rotation) | W | Entities.Transform + Pattern D | Medium | ❌ | 🟢 | Anne-Francoise |
...
| S-082 | Lire codes et pilotes d'une inclusion | R | Assemblies.GetInclusionCodeAndDrivers | Medium | ❌ | 🟢 | Anne-Francoise |
| S-083 | Creer inclusion simple (CreateInclusion2) | W | Assemblies.CreateInclusion2 + Pattern D | Complex | ❌ | 🟢 | Anne-Francoise |
| S-084 | Creer inclusion parametree (SmartPoint/Profile/Real) | W | Assemblies.CreateInclusion + SmartObjects + Pattern D | Complex | ❌ | 🟢 | Anne-Francoise |
| S-085 | Creer contrainte frame-on-frame | W | Assemblies.CreateFrameOnFrameConstraint | Complex | ❌ | 🟢 | InclusionManager |
| S-086 | Modifier code/pilotes inclusion | W | Assemblies.SetInclusionCodeAndDrivers2 + Pattern D | Complex | ❌ | 🟢 | Anne-Francoise |
| S-087 | Derive Part for Modification | W | Assemblies.DerivePartForModification | Complex | ❌ | 🟡 | Anne-Francoise |
| S-088 | Substitution composants | RW | Substitutions.SubstituteGlobalComponent, GetSubstitutableElements | Complex | ❌ | 🟡 | Anne-Francoise |
| S-089 | Gerer collisions assemblage | W | Assemblies.SetCollisionsManagement | Medium | ❌ | 🟡 | Anne-Francoise |
...
| S-101 | Lire codes famille | R | Families.GetCodes | Simple | ❌ | 🟢 | Anne-Francoise |
| S-102 | Lire instances explicites | R | Families.GetExplicitInstances | Medium | ❌ | 🟢 | KernelExamples |
| S-103 | Lire document generique | R | Families.GetGenericDocument | Simple | ❌ | 🟢 | Anne-Francoise |
...
| S-107 | Lire contraintes famille | R | Families.GetConstrainedEntityCount, GetOrderedConstrainedDrivers | Medium | ❌ | 🟡 | Anne-Francoise |
| S-108 | Gerer colonnes catalogue famille | W | Families.AddCatalogColumn, RemoveCatalogColumn | Medium | ❌ | 🟡 | Anne-Francoise |
| S-109 | Lire/modifier conditions pilotes famille | RW | Families.GetDriverCondition, GetDriverFolderCondition | Complex | ❌ | 🟡 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-110 | Lister les exporteurs disponibles | R | Application.ExporterCount, GetExporterFileType | Simple | ❌ | 🟢 | Anne-Francoise |
| S-111 | Lister les importeurs disponibles | R | Application.ImporterCount, GetImporterFileType | Simple | ❌ | 🟢 | Anne-Francoise |
| S-112 | Verifier si export possible | R | Documents.CanExport | Simple | ❌ | 🟢 | Anne-Francoise |
| S-113 | Exporter en STEP | W | Documents.Export (index STEP) | Medium | ❌ | 🟢 | Anne-Francoise |
| S-114 | Exporter avec options (CATPart, FBX, GLTF) | W | Documents.ExportWithOptions | Medium | ❌ | 🟢 | Anne-Francoise |
| S-115 | Importer STEP avec options | RW | Documents.ImportWithOptions | Complex | ❌ | 🟢 | Anne-Francoise |
| S-116 | Importer avec representations | RW | Documents.Import + Representations management | Complex | ❌ | 🟢 | Anne-Francoise |
| S-117 | Export Parasolid avec Enclosing Box | RW | Parts.SetEnclosingBoxManagement + ExportWithOptions | Complex | ❌ | 🟡 | Anne-Francoise |
| S-118 | Export Viewer Package | W | Pdm.ExportViewerPackage | Medium | ❌ | 🟡 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-120 | Lire tableaux cotation | R | Tables.GetDraftTables, GetDraftTableCellType, GetDraftTableCellText | Medium | ❌ | 🟡 | Anne-Francoise |
| S-121 | Creer cotation lineaire | W | Draftings.CreateLinearDimensionBetweenTwoPoints | Medium | ❌ | 🟡 | Anne-Francoise |
| S-122 | Lire vues projection | R | Draftings.GetDraftingViews | Simple | ❌ | 🟡 | Anne-Francoise |
| S-123 | Creer ensemble projection | W | Draftings.CreateNewProjectionSet | Medium | ❌ | 🟡 | Anne-Francoise |
| S-124 | Modifier couleur fond cellule | W | Tables.SetDraftTableCellBackgroundColor | Simple | ❌ | 🟡 | Anne-Francoise |
| S-125 | Appliquer style texte | W | Styles.GetStyles, Styles.ApplyStyle | Simple | ❌ | 🟡 | Anne-Francoise |
...
| S-141 | Creer document materiau | W | Pdm.CreateDocument + Materials.SetCategory/SetDensity/SetMaterialModel | Complex | ❌ | 🟡 | Anne-Francoise |
| S-142 | Creer textures PBR (Albedo, Roughness, etc.) | W | Textures.SetPicture, SetCategory, Coatings.SetAlbedoTextureDocument | Complex | ❌ | 🟡 | Anne-Francoise |
| S-143 | Recuperer images textures | R | Materials.OpenTextureRetrievalSession, GetTextureImage | Medium | ❌ | 🟡 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-150 | Lire/modifier categorie multi-couche | RW | MultiLayers.GetCategory, SetCategory | Simple | ❌ | 🟡 | Anne-Francoise |
| S-151 | Gerer coatings multi-couche | RW | MultiLayers.Get/SetTopCoating, Get/SetBottomCoating | Medium | ❌ | 🟡 | Anne-Francoise |
| S-152 | Gerer finishings multi-couche | RW | MultiLayers.Get/SetTopFinishing, Get/SetBottomFinishing | Medium | ❌ | 🟡 | Anne-Francoise |
| S-153 | Definir couches multi-materiaux | W | MultiLayers.SetMultiMaterialLayers, AddMultiMaterialLayer | Medium | ❌ | 🟡 | Anne-Francoise |
| S-154 | Lire epaisseur totale | R | MultiLayers.GetMultiLayerTotalThickness | Simple | ❌ | 🟡 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-170 | Lire Von Mises min/max | R | CaeHost.Results.GetVonMisesMinAndMaxResults | Simple | ❌ | 🔴 | Anne-Francoise |
| S-171 | Lire Displacement min/max | R | CaeHost.Results.GetDisplacementMinAndMaxResults | Simple | ❌ | 🔴 | Anne-Francoise |
| S-172 | Lire limite elastique materiau | R | CaeHost.Results.GetMaterialElasticLimit | Simple | ❌ | 🔴 | Anne-Francoise |
| S-173 | Modifier taille maillage + resoudre | W | CaeHost.Documents.SetMeshTargetSize, Solve | Medium | ❌ | 🔴 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-180 | Generer code ISO (NC) | W | NCPostProcessor.GenerateNCCodesWithOptions | Complex | ❌ | 🔴 | Anne-Francoise |
| S-181 | Creer operation process usinage | W | Parts.CreateMachiningProcessOperation | Complex | ❌ | 🟡 | Anne-Francoise |
| S-182 | Lire conditions de coupe | R | Operations.GetNCOperation, GetAllCuttingConditionsAbacus | Complex | ❌ | 🔴 | Anne-Francoise |
...
| ID | Scenario | Type | APIs cles | Complexite | Test | Graphe | Source |
|----|----------|------|-----------|-----------|------|--------|--------|
| S-190 | Creer layer | W | Layers.CreateLayer + Pattern D | Simple | ❌ | 🟡 | Anne-Francoise |
| S-191 | Creer percage (drilling) | W | Parts.CreateDrillingOperation + Pattern D | Complex | ❌ | 🟡 | Anne-Francoise |
| S-192 | Definir process sur piece | W | Processes.DefineProcess | Medium | ❌ | 🟡 | Anne-Francoise |

...
Le MCP devient **le cerveau**, le graph **la memoire**, les recettes **le savoir-faire valide**, les exemples FEA/AF/RoB **les patterns production**.
